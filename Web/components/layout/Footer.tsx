...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-ios-black text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">RaiseYourVoice</h3>
            <p className="text-gray-300 mb-4">{t('footer.tagline')}</p>
            <div className="flex space-x-4">
              <a
                href="https://twitter.com/raiseyourvoice"
                target="_blank"
              ...
              <a
                href="https://facebook.com/raiseyourvoice"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white"
                aria-label="Facebook"
              ...
              <a
                href="https://instagram.com/raiseyourvoice"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white"
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <a
                  href="mailto:info@raiseyourvoice.al"
                  className="text-gray-300 hover:text-white"
                >
                  info@raiseyourvoice.al
                </a>
              </li>
              <li className="flex items-start">
                <svg
                ...
                <span className="text-gray-300">+355 42 123 456</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="h-5 w-5 text-gray-300 mr-2 mt-0.5"
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-300">
            &copy; {currentYear} RaiseYourVoice. {t('footer.rights')}
          </p>
        </div>
      </div>
    </footer>
